...
const Home: NextPage = () => {
  return (
    <div className='max-w-7xl mx-auto min-h-screen min-w-full'>
      <div className=' bg-white rounded-xl shadow-xl my-10 px-10 py-20 grid grid-cols-[1fr_10rem] grid-rows-2  gap-y-4 items-center'>
        <h2 className='font-medium '>Coding Question</h2>
        <button className='text-main-blue rounded-lg bg-slate-200 px-4 py-5 self-end'> New Questions</button>
