...
function Home() {
  ...
  const handleSubmit = async e => {
    e.preventDefault(0);
    axios.post('/api/tests', { language: ['63'] }).then(response => {
      const href = response.data.hash;
      router.push(href);
        ...
        <div className="pt-24">
          <div className="container max-w-7xl px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-3/5 py-6 text-center">
              <Image className="w-full md:w-4/5 z-50" src="/main.png" width={613} height={539} />
            </div>
          </div>
        </div>
