...
const Score = () => {
    ...
    return (
        <div className='bg-slate-200 py-10 px-10 rounded-lg relative'>

            {/* <span className='z-10 absolute align-middle content-between min-w-full'>
                <svg role="status" class="inline w-20 h-20 mr-2 text-slate-300 animate-spin dark:text-slate-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
